...
OPEARTOR_IMAGE_TAG=v$(OPERATOR_VERSION)
BUNDLE_IMAGE?=$(IMAGE_REGISTRY)/$(IMAGE_REPOSITORY)/$(IMAGE_NAME)-bundle
CATALOG_IMAGE?=$(IMAGE_REGISTRY)/$(IMAGE_REPOSITORY)/$(IMAGE_NAME)-catalog
