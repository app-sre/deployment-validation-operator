...
func setupManager(log logr.Logger, opts dvConfig.Options) (manager.Manager, error) {
	logVersion(log)
...
func getManagerOptions(scheme *k8sruntime.Scheme, opts dvConfig.Options) (manager.Options, error) {
